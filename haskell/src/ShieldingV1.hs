...
-- This is a checkpoint that matches the paper more closely
-- However it became unclear how to solve the Winning Region using the definitions of
-- the paper specifically in Game and explainations on game solving
-- ShieldingV2.hs makes adjustments to make it more clear.
-- I think it's important to preserve this version and possibly adopting it later
...
-- TODO compute with this verison of it
